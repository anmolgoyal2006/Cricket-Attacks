...
// Battle state flow (PvE): 'computer-choosing' â†’ 'choosing' â†’ 'revealing' â†’ 'roundResult'
...
export default function BattlePage() {
  ...
  useEffect(() => {
    ...
    async function fetchCards() {
      try {
        // Fetch all cards â€” get first page to know total, then fetch all at once
              ...
              <div className="glass rounded-2xl p-6">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                  {playerHand.map((card) => {
                    ...
                    // Clickable only when it is the player turn to pick
                    ...
                    // Stats only revealed on the played card after round result arrives
