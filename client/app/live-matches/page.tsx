...
import { Radio, Calendar, MapPin, Loader2, RefreshCw, AlertCircle } from 'lucide-react';
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
            <div className="text-center sm:text-left">
              ...
              >
                <Radio className="w-4 h-4 text-amber-400 mr-2 animate-pulse" />
                <span className="text-sm text-amber-400 font-body font-semibold">LIVE NOW</span>
              </motion.div>
              
              <h1 className="text-5xl sm:text-6xl font-display font-black mb-4">
            ...
            <motion.button
              ...
              disabled={refreshing}
              className="flex items-center space-x-2 px-6 py-3 rounded-xl bg-gradient-to-r from-amber-500 to-orange-600 text-white font-display font-bold text-lg shadow-2xl shadow-amber-500/50 hover:shadow-amber-500/70 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
        ...
        <section className="py-8 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              className="glass rounded-2xl p-6 border-2 border-red-500/50"
            >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {matches.map((match, index) => (
                <motion.div
                  ...
                  className="glass rounded-2xl p-6 relative overflow-hidden hover:bg-white/5 transition-all"
                >
                  {/* Live Indicator */}
                  <div className="absolute top-4 right-4 flex items-center space-x-2 px-3 py-1 rounded-full bg-gradient-to-r from-amber-500/20 to-orange-500/20 border border-amber-500/30">
                    <div className="w-2 h-2 rounded-full bg-amber-400 animate-pulse" />
                    <span className="text-xs text-amber-400 font-body font-semibold">LIVE</span>
                  </div>
