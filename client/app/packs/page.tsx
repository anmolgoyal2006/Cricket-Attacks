...
import { Sparkles, Gift, ChevronRight, Loader2, AlertCircle, Trophy } from 'lucide-react';
...
export default function PacksPage() {
  ...
  const openPremiumPack = async () => {
    ...
    try {
      const data = await packsApi.openPack('premium');
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-300 font-body">
            Unlock random cricket cards and expand your collection
          </p>
          <div className="flex items-center justify-center mt-4 space-x-2">
            <Trophy className="w-5 h-5 text-amber-400" />
            <span className="text-amber-400 font-display font-bold">{coins} coins</span>
          </div>
        </div>

        {error && (
          <div className="max-w-md mx-auto mb-8 p-4 rounded-xl bg-red-500/10 border border-red-500/30 flex items-center space-x-3">
                  ...
                  >
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center p-8">
                      ...
                      <div className="px-6 py-3 rounded-full bg-white/20 backdrop-blur-sm border-2 border-white/40">
                        <p className="text-white font-body font-bold">3 Cards Inside</p>
                      </div>
                    </div>
