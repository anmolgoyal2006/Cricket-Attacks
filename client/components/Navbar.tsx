...
import { Trophy, Sparkles, Swords, Users, Home, Grid3x3, LogIn, UserPlus, LogOut, Radio, Hash, HelpCircle } from 'lucide-react';
...
export default function Navbar() {
  ...
  const navItems = [
    ...
    { href: '/wordle', label: 'Wordle', icon: Hash },
    { href: '/quiz', label: 'Who Said This?', icon: HelpCircle },
          ...
          <div className="flex items-center space-x-3">
            {loading ? (
              ...
              <>
                ...
                <button
                  onClick={logout}
                  className="flex items-center space-x-2 px-3 py-2 rounded-lg bg-white/5 hover:bg-white/10 transition-all group border border-white/10"
                >
              ...
              <div className="flex items-center space-x-2">
                <Link
                  href="/login"
                  className="px-4 py-2 rounded-lg bg-white/5 border border-white/10 text-gray-300 hover:text-amber-400 hover:bg-white/10 transition-all font-body text-sm flex items-center space-x-1.5"
                >
                ...
                <Link
                  href="/register"
                  className="px-4 py-2 rounded-lg bg-gradient-to-r from-amber-500 to-orange-600 text-white font-body text-sm font-semibold hover:shadow-lg hover:shadow-amber-500/30 transition-all flex items-center space-x-1.5"
                >
